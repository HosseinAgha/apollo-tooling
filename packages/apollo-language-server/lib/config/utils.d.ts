...
export declare function isClientConfig(
  config: ApolloConfig
): config is ClientConfig;
export declare function isLocalServiceConfig(
  config: ClientServiceConfig
): config is LocalServiceConfig;
export declare function isServiceConfig(
  config: ApolloConfig
...
export declare function getServiceName(
  config: ApolloConfigFormat
): string | undefined;
export declare function parseServiceSpecifier(
